...
let tableauSocle = [new Socle((wind.w/3)-175,400),new Socle((wind.w/3*2)-175,400),new Socle((wind.w/3*3)-175,400)]
...
document.querySelector('.newGame').addEventListener('click', () => {
    ...
    Game_init(new Tuile(20,15,30,25,1,"#FF0000"),
              new Tuile(20,15,30,25,2,"#00FF00"),
              new Tuile(20,15,30,25,3,"#0000FF"),
              new Tuile(20,15,30,25,4,"#FF0E0A")
            );
})
